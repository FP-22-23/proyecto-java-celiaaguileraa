...
public class test {
	public static void main(String[] args) {
		...
		Perros p1= new Perros(23807, "Gida", 25, Genero.FEMALE, breed, LocalDate.of(2019, 12, 10), LocalDate.of(2019,  12, 1), Pelaje.SHORT, Tamaño.SMALL, false, 11.14 );
		System.out.println(p1);
		List<String> breed2= List.of("Bull Terrier, Dachshund Mix");
		Perros p2= new Perros(532, "Fickó", 15, Genero.MALE, breed2, LocalDate.of(2019,  12, 1), LocalDate.of(2019,  12, 2), Pelaje.SHORT, Tamaño.MEDIUM, true, 14.14);
		System.out.println(p2);
		List<String> breed3= List.of("Vizsla Mix");
		Perros p3= new Perros(1222, "Vasi", 367, Genero.MALE, breed3, LocalDate.of(2019,  10, 25), LocalDate.of(2019,  10, 26), Pelaje.SHORT, Tamaño.MEDIUM, true, 46.77);
